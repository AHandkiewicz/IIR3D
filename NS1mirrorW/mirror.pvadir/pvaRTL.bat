...
:-------------------------------------------------------
: Product : Hspice
: File:  pvaRTL.bat   17:48:44 04/16/2025
:
...
: COMPILE
%GCC% %PVA_CDEFS% %PVA_GCC_FLAGS% %PVA_GCC_DLL_FLAGS% -DWIN32 "Z:\SIdesign\NS1mirrorW\mirror.pvadir\pvaSetExtern.o" "Z:/SIdesign/NS1mirrorW/mirror.pvadir/bsimcmg.o" -o "Z:\SIdesign\NS1mirrorW\mirror.pvadir\pvaRTL_win64.dll"
