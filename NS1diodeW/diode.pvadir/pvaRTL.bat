...
:-------------------------------------------------------
: Product : Hspice
: File:  pvaRTL.bat   19:00:12 04/07/2025
:
...
: COMPILE
%GCC% %PVA_CDEFS% %PVA_GCC_FLAGS% %PVA_GCC_DLL_FLAGS% -DWIN32 "Z:\SIdesign\NS1diodeW\diode.pvadir\pvaSetExtern.o" "Z:/SIdesign/NS1diodeW/diode.pvadir/bsimcmg.o" -o "Z:\SIdesign\NS1diodeW\diode.pvadir\pvaRTL_win64.dll"
